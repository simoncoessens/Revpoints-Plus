"use client"
import { Search, Menu, Plus, MoreHorizontal, Info, Coins, Diamond, ChevronRight, Heart } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="flex items-center justify-between px-4 py-2 relative z-10">
        ...
        <div className="flex-1 mx-2">
          <div className="relative">
            ...
            <Input className="w-full bg-gray-700/70 border-0 rounded-full pl-10 text-gray-200" placeholder="Search" />
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center mt-12 mb-6 relative z-10">
        ...
        <Button variant="secondary" className="rounded-full bg-gray-700/70 text-white px-8">
          Upgrade
        </Button>
      </div>
        ...
        <div className="bg-gray-900/90 rounded-t-3xl p-4">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4">
              ...
              <div className="min-w-[280px] bg-gray-800 rounded-xl overflow-hidden">
                <div className="relative h-40 w-full">
                  ...
                  <Image src="/restaurant-1.png" alt="La Uramakeria" fill className="object-cover" />
                  <div className="absolute bottom-3 left-3 bg-black/70 px-3 py-1 rounded-md">
                    <span className="text-xs text-white">Eatsclusive with Uber Eats</span>
                  </div>
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center text-sm text-gray-400 gap-1">
                    <span className="inline-block bg-amber-500 text-black p-1 rounded-full">
                    ...
                    <span>• 1.59 € Delivery Fee</span>
                  </div>
                  <div className="flex items-center mt-1">
                    <span className="text-sm font-medium">4.4</span>
                    <span className="text-sm text-gray-400 ml-1">(2,000+) • 40 min</span>
                  </div>
                </div>
              </div>
              ...
              <div className="min-w-[280px] bg-gray-800 rounded-xl overflow-hidden">
                <div className="relative h-40 w-full">
                  ...
                  <Image src="/restaurant-2.png" alt="ALOHA" fill className="object-cover" />
                  <button className="absolute top-3 right-3 bg-white/20 p-1 rounded-full backdrop-blur-sm">
                    <Heart className="h-5 w-5 text-white" />
                  </button>
                </div>
                <div className="p-3">
                  ...
                  <div className="flex items-center text-sm text-gray-400 gap-1">
                    ...
                    <span>• 0.49 € Delivery Fee</span>
                  </div>
                  <div className="flex items-center mt-1">
                    <span className="text-sm font-medium">4.1</span>
                    <span className="text-sm text-gray-400 ml-1">(1,000+) • 25 min</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4">
              ...
              <div className="flex flex-col items-center min-w-[80px]">
                <div className="h-20 w-20 rounded-full bg-white p-2 mb-2">
                  <div className="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    <Image
                      src="/store-carrefour.png"
                      alt="Carrefour"
                      width={70}
                      height={70}
                ...
                <span className="text-sm font-medium">Carrefour</span>
              ...
              <div className="flex flex-col items-center min-w-[80px]">
                <div className="h-20 w-20 rounded-full bg-white p-2 mb-2">
                  <div className="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    <Image src="/store-condis.png" alt="Condis" width={70} height={70} className="object-contain" />
                  </div>
                </div>
                <span className="text-sm font-medium">Condis</span>
                <div className="flex items-center text-xs text-gray-400">
                  <svg
              ...
              <div className="flex flex-col items-center min-w-[80px]">
                <div className="h-20 w-20 rounded-full bg-white p-2 mb-2">
                  <div className="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    <Image src="/store-dia.png" alt="Dia" width={70} height={70} className="object-contain" />
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center min-w-[80px]">
                <div className="h-20 w-20 rounded-full bg-white p-2 mb-2">
                  <div className="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    <Image
                      src="/store-carrefour-express.png"
                ...
                <span className="text-sm font-medium">Carrefour Express</span>
                <div className="flex items-center text-xs text-gray-400">
                  <svg
                    className="h-3 w-3 text-green-500 mr-1"
                    viewBox="0 0 24 24"
              ...
              <div className="flex flex-col items-center min-w-[80px]">
                <div className="h-20 w-20 rounded-full bg-white p-2 mb-2">
                  <div className="h-full w-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                    <Image src="/store-clarel.png" alt="Clarel" width={70} height={70} className="object-contain" />
                  </div>
                </div>
                <span className="text-sm font-medium">Clarel</span>
                <div className="flex items-center text-xs text-gray-400">
                  <svg
                    className="h-3 w-3 text-green-500 mr-1"
                    viewBox="0 0 24 24"
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4">
              ...
              <div className="min-w-[280px] bg-gray-800 rounded-xl overflow-hidden">
                <div className="relative h-40 w-full">
                  <Image src="/order-again-1.png" alt="Previous order" fill className="object-cover" />
                </div>
                <div className="p-3">
                  <h3 className="text-lg font-semibold">McDonald's</h3>
                  <div className="flex items-center mt-1">
                    <span className="text-sm text-gray-400">Ordered 3 days ago</span>
                  </div>
                </div>
              </div>
              ...
              <div className="min-w-[280px] bg-gray-800 rounded-xl overflow-hidden">
                <div className="relative h-40 w-full">
                  ...
                  <Image src="/order-again-2.png" alt="Previous order" fill className="object-cover" />
                </div>
                <div className="p-3">
                  <h3 className="text-lg font-semibold">Sushi Shop</h3>
                  <div className="flex items-center mt-1">
                    <span className="text-sm text-gray-400">Ordered 1 week ago</span>
                  </div>
                </div>
              </div>
            </div>
